            ...
            <div class="col-sm-12">
                <div class="trans-layout card  mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold"><i class="fas fa-file-import"></i> OUTBOX TRANSACTIONS</h6>
                    </div>
                </div>
            </div>

            <div class="col-sm-12">
                <table id="myTableOutboxList" class="table table-responsive table-striped table-bordered table-sm" cellspacing="0" width="100%" >
                    <thead>
                        <tr>
                            <th>ODTS No.</th>
                            <th>Category</th>
        ...
        <div class="modal-dialog modal-xl" >
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-sm btn-warning mr-auto" target="_blank" id="ar" ><span class="btn-label"><i class="fas fa-print"></i></span> Print AR</a>
...
$(document).ready(function(e){
        ...
        $('#myTableOutboxList').DataTable({
            ...
            'order': [],
            'ajax': {
                url : base_url+'Outboxcontroller/dms_outbox_list_ajax/'+<?php echo $_SESSION['userid']; ?>,
                type : 'POST',
                dataSrc: function(json) {
                    ...
                    if (json && Array.isArray(json.data)) {
                        if (json.data.length === 0) {
                            ...
                            $('#myTableOutboxList tbody').html('<tr><td colspan="100%" class="text-center">No records found</td></tr>');
                            return [];
                        }
                        return json.data;
                    }
    ...
    $(document).on('click', '#viewBtn', function() {
        ...
        $.ajax({
            ...
            $('#historyTable').DataTable({
                ...
                "bDestroy": true,
                'ajax': {
                    url : base_url+'Inboxcontroller/dms_history_list_ajax/' + id,
                    type : 'POST',
                },
            });
    });
