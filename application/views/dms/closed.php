            ...
            <div class="col-sm-12">
                ...
                <div class="trans-layout card  mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold"><i class="fas fa-folder-closed"></i> FILED/CLOSED TRANSACTIONS</h6>
                    </div>
                </div>
            </div>

            <div class="col-sm-12">
                <table id="myTableClosedList" class="table table-responsive table-striped table-bordered table-sm" cellspacing="0" width="100%" >
                    <thead>
                        <tr>
                            <th>ODTS No.</th>
                            <th>Category</th>
...
$(document).ready(function(e){
        ...
        $('#myTableClosedList').DataTable({
            ...
            'order': [],
            'ajax': {
                url : base_url+'Inboxcontroller/dms_closed_list_ajax/'+<?php echo $_SESSION['userid']; ?>,
                type : 'POST'
            },
            language: {
