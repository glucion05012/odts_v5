            ...
            <div class="col-sm-12">
                ...
                <div class="trans-layout card  mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold"><i class="fas fa-file-import"></i> INCOMING TRANSACTIONS</h6>
                    </div>
                </div>
            </div>

            <div class="col-sm-12">
                <table id="myTableInboxList" class="table table-responsive table-striped table-bordered table-sm" cellspacing="0" width="100%" >
                    <thead>
                        <tr>
                            <th >Days Pending</th>
                            <th>ODTS No.</th>
...
$(document).ready(function(e){
    ...
    $(document).on('click', '#receiveBtn', function() {
        ...
        <?php if(isset($_SESSION['userid'])) : ?>
            var transaction_id = $(this).data("var2");
            var transaction_id_encoded = $(this).data("var3");
            var reference_no = $(this).data("var1");
            Swal.fire({
                title: "Confirm.",
                ...
                denyButtonText: `Receive and Process`,
            }).then((result) => {
                        ...
                        , error: function() {
                            ...
                            Swal.fire({
                                ...
                                html: "Transaction Successfully Received. <br> Reference No. <b style='color:blue'>" + reference_no + "</b>.",
                                    ...
                                    window.location = "<?php  echo base_url(); ?>"+'inbox/process/'+transaction_id_encoded+'/regular';
                            });
                        }
                    })  
